        ...
        <div class="wrapper-page">
                    ...
                    <div class="m-t-10 p-20">
                        <div class="row">
                            <div class="col-xs-12 text-xs-center">
                                <h6 class="text-muted text-uppercase m-b-0 m-t-0">SignUp</h6>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="a" value="signup">
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    <input class="form-control" type="email" name="email1" placeholder="Repeat E-Mail">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center row m-t-10">
                                <div class="col-xs-12">
                                    <button class="btn btn-success btn-block waves-effect waves-light" type="submit">SignUp</button>
                                </div>
                            </div>
            ...
            <div class="m-t-20">
                <div class="text-xs-center">
                    <p class="text-white">Have an account? <a href="/Auth" class="text-white m-l-5"><b>Login</b></a></p>
                </div>
            </div>
