        ...
        <div class="wrapper-page">
        	...
        	<div class="account-bg">
                <div class="card-box m-b-0">
                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <form class="m-t-20" action="/Auth/Reminder" method="post" name="loginform">
                        <input type="hidden" name="a" value="reminder">
                            ...
                            <div class="form-group text-center row m-t-10">
                                <div class="col-xs-12">
                                    <button class="btn btn-success btn-block waves-effect waves-light" type="submit">Recover password</button>
                                </div>
                            </div>

                            <div class="form-group row m-t-30 m-b-0">
                                <div class="col-sm-12">
                                    <a href="/Auth/" class="text-muted"><i class="fa fa-lock m-r-5"></i> Login to your account</a>
                                </div>
                            </div>
            ...
            <div class="m-t-20">
                <div class="text-xs-center">
                    <p class="text-white">No account? <a href="<?=base_url();?>Auth/Register" class="text-white m-l-5"><b>SignUp</b></a></p>
                </div>
            </div>
