                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="section-title title-divider text-left mb-40">
                                    <h3 class="title">Калькулятор доходности</h3>
                            ...
                            <div class="col-lg-4">
                                <div class="contents">
                                   <table class="table table-bordered">
                                   	...
                                   	<td>Валюта: <select onchange="SelectCoin()" class="form-control" id="SelectCoin">
                                   	...
                                   	<tr><td>Облако GHS: <input class="form-control" type="text" id="CountCloud" value=""></td></tr>
                                   	<tr><td>Сумма <span id="qqq">BTC</span>: <input class="form-control" type="text" id="CountCrypto" value=""></td></tr>
                                   	<tr><td>Сумма BTC: <input disabled="disabled" class="form-control" type="text" id="CountCryptoBtc" value=""></td></tr>
                                   </table>
                                </div>
                            </div>
