                    ...
                    <div class="m-t-10 p-20">
                        <div class="row">
                            <div class="col-xs-12 text-xs-center">
                                <h6 class="text-muted text-uppercase m-b-0 m-t-0">Востановление пароля</h6>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="a" value="reminder">
                            ...
                            <div class="form-group text-center row m-t-10">
                                <div class="col-xs-12">
                                    <button class="btn btn-success btn-block waves-effect waves-light" type="submit">Востановить</button>
                                </div>
                            </div>

                            <div class="form-group row m-t-30 m-b-0">
                                <div class="col-sm-12">
                                    <a href="/Auth/" class="text-muted"><i class="fa fa-lock m-r-5"></i> Вход в аккаунт</a>
                                </div>
                            </div>
