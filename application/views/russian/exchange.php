...
<div class="row">
                    <div class="col-sm-12">
                        ...
                        <center><h2 class="page-title">Обмен валют (Комиссия 10%)</h2></center>
                    </div>
                </div>
	...
	<div class="col-lg-12">
		...
		<div class="card-box">
			<table class="table table-bordered">
				<tr>
					<td style="width: 50%;">
						Отдаете: <span id="coin_1"></span><input class="form-control" id="amount1" type="text" name="amount1" value="0">
					</td>
					<td style="width: 50%;">
						Получаете: <span id="coin_2"></span><input class="form-control" type="text" id="amount2" name="amount2" value="0" disabled="disabled">
					</td>
				</tr>
				<tr>
					<td colspan="2" class="text-center">
						<input type="submit" onClick="ExchangeComplite(); return false;" class="btn btn-success" value="Обменять">
					</td>
				</tr>
			</table>
		</div>
