...
<div class="row">
                    <div class="col-sm-12">
                        ...
                        <center><h2 class="page-title">Список криптовалют</h2></center>
                    </div>
                </div>
                  ...
                  <table class="table" id="datatables__example">
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        if($query->num_rows() == 1):
                        ?>
                        <td align="center"><button type="button" disabled="disabled" class="btn btn-success">Включено</button></td>
                        <? else: ?>
                        
                        <td align="center">
                        <b id="ButtonCoins_<?=$Coin->cUid;?>"></b>
                        <input  id="ButtonCoin_<?=$Coin->cUid;?>" type="submit" class="<? if($query->num_rows() == 0) echo 'btn btn-warning'; ?>" value="<? if($query->num_rows() == 0) echo 'Включить'; ?>" onClick="ResetOnlineOfflineCoin('<?=$Coin->cUid;?>'); return false;"></td>
